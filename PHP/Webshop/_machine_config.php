...
GlobalConfig::$CONNECTION_SETTING->DBName = "webshop";
...
/** the root url of the application with trailing slash, for example http://localhost/webshop/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'webshop/';
