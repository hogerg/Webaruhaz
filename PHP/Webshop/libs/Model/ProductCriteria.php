...
require_once("DAO/ProductCriteriaDAO.php");

/**
 * The ProductCriteria class extends ProductDAOCriteria and is used
 ...
 * @version 1.0
 */
class ProductCriteria extends ProductCriteriaDAO
{
