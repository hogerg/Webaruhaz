...
require_once("DAO/OrderDetailsCriteriaDAO.php");

/**
 * The OrderDetailsCriteria class extends OrderDetailsDAOCriteria and is used
 ...
 * @version 1.0
 */
class OrderDetailsCriteria extends OrderDetailsCriteriaDAO
{
