/**
 * backbone model definitions for WEBSHOP
 */
 ...
 */
model.CategoryCollection = model.AbstractCollection.extend({
	url: 'api/categories',
...
/**
 * OrderDetails Backbone Model
 */
model.OrderDetailsModel = Backbone.Model.extend({
	urlRoot: 'api/orderdetails',
	idAttribute: 'id',
	id: '',
	amount: '',
	price: '',
...
/**
 * OrderDetails Backbone Collection
 */
model.OrderDetailsCollection = model.AbstractCollection.extend({
	url: 'api/orderdetailentries',
 ...
 */
model.ProductModel = Backbone.Model.extend({
	urlRoot: 'api/product',
	idAttribute: 'id',
	id: '',
	name: '',
...
/**
 * Product Backbone Collection
 */
model.ProductCollection = model.AbstractCollection.extend({
	url: 'api/products',
